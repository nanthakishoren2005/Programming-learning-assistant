    ...
    "python": {
        "beginner": [
            {
                ...
                "difficulty": "easy",
                "concepts": ["print", "variables", "strings"],
            ...
            },
            {
                ...
                "difficulty": "easy",
                "concepts": ["input", "math", "type casting"],
        ...
        "intermediate": [
            ...
            },
            {
                ...
                "difficulty": "medium",
                "concepts": ["dictionaries", "strings", "functions"],
        ...
        "advanced": [
            {
                ...
                "difficulty": "hard",
                "concepts": ["file I/O", "sorting", "dictionaries"],
    ...
    "html": {
        "beginner": [
            {
                ...
                "difficulty": "easy",
                "concepts": ["boilerplate", "headings", "structure"],
                "estimatedTime": "10 min",
        ...
        "intermediate": [
            ...
            },
            {
                ...
                "difficulty": "medium",
                "concepts": ["forms", "inputs", "labels", "select"],
                "estimatedTime": "25 min",
        ...
        "advanced": [
            ...
            },
            {
                ...
                "difficulty": "hard",
                "concepts": ["HTML5 validation", "forms", "patterns"],
                "estimatedTime": "30 min",
        ...
        "beginner": [
            {
                ...
                "difficulty": "easy",
                "concepts": ["color", "font-family", "selectors"],
                "estimatedTime": "10 min",
                "starter": "<style>\n  /* Add your CSS here */\n</style>\n<h1>Hello CSS</h1>"
            },
            {
            ...
            },
            {
                ...
                "difficulty": "easy",
                "concepts": ["class selector", "ID selector"],
                "estimatedTime": "10 min",
        ...
        "intermediate": [
            {
                ...
                "difficulty": "medium",
                "concepts": ["box-shadow", "border-radius", "hover"],
                "estimatedTime": "25 min",
            ...
            },
            {
                ...
                "difficulty": "medium",
                "concepts": ["flexbox", "justify-content", "align-items"],
                "estimatedTime": "20 min",
            ...
            },
            {
                ...
                "difficulty": "medium",
                "concepts": ["transitions", "transform", "hover"],
                "estimatedTime": "15 min",
        ...
        "advanced": [
            {
                ...
                "difficulty": "hard",
                "concepts": ["css grid", "grid-template", "spanning"],
                "estimatedTime": "30 min",
            ...
            },
            {
                ...
                "difficulty": "hard",
                "concepts": ["media queries", "responsive design", "flexbox"],
                "estimatedTime": "30 min",
            ...
            },
            {
                ...
                "difficulty": "hard",
                "concepts": ["keyframes", "animation", "transform"],
                "estimatedTime": "25 min",
...
output_path = 'js/task-data.js'
content = '// ============================================\n'
content += '// Task Data — coding challenges per language and level\n'
content += '// ============================================\n'
content += 'export const tasks = ' + json.dumps(tasks, indent=2) + ';\n'

with open(output_path, 'w', encoding='utf-8') as f:
    f.write(content)

print(f"Successfully wrote tasks to {output_path}")
